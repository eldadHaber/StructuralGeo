...
|------|------|-----------|------------------|---------------------|
| 1 | lower_sediments | shale | -211 | 2.0e-05 |
| 2 | middle_sediments | sandstone | -172 | 3.0e-05 |
| 3 | upper_sediments | siltstone | -188 | 2.0e-05 |
| 4 | conglomerate | conglomerate | -133 | 4.0e-05 |
| 5 | alluvium | alluvium | -491 | 1.0e-05 |
| 6 | mafic_dike | basalt | 358 | 2.0e-02 |
| 8 | rhyolitic_dike | rhyolite | 237 | 4.0e-03 |
| 9 | felsic_pluton | granodiorite | 303 | 5.0e-03 |
| 11 | mafic_pluton | gabbro | 378 | 8.0e-02 |

## Regenerate

```python
from geogen.stratiflow import GenerationConfig, generate_sample
cfg = GenerationConfig(seed=100)
