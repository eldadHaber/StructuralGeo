...
- Boreholes: 8
- Surface relief: 800 m

## Lithology vocabulary

| Code | Unit | Lithology | Density (kg/m^3) | Susceptibility (SI) |
|------|------|-----------|------------------|---------------------|
| 1 | lower_sediments | shale | -255 | 2.0e-05 |
| 2 | middle_sediments | sandstone | -190 | 3.0e-05 |
| 3 | upper_sediments | siltstone | -129 | 2.0e-05 |
| 4 | conglomerate | conglomerate | -171 | 4.0e-05 |
| 5 | alluvium | alluvium | -383 | 1.0e-05 |
| 6 | mafic_dike | basalt | 378 | 2.0e-02 |

## Regenerate

```python
from geogen.stratiflow import GenerationConfig, generate_sample
cfg = GenerationConfig(seed=102)
