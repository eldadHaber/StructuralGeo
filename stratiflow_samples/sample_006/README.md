...
- Boreholes: 8
- Surface relief: 350 m

## Lithology vocabulary

| Code | Unit | Lithology | Density (kg/m^3) | Susceptibility (SI) |
|------|------|-----------|------------------|---------------------|
| 1 | lower_sediments | shale | -226 | 2.0e-05 |
| 2 | middle_sediments | sandstone | -148 | 3.0e-05 |
| 4 | conglomerate | conglomerate | -182 | 4.0e-05 |
| 5 | alluvium | alluvium | -353 | 1.0e-05 |
| 11 | mafic_pluton | gabbro | 441 | 8.0e-02 |

## Regenerate

```python
from geogen.stratiflow import GenerationConfig, generate_sample
cfg = GenerationConfig(seed=105)
