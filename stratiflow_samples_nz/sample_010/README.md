...
- CRS: `EPSG:2193`  (origin xy abs = 1402480.6, 4975102.0 m; z_top abs = 553.5 m)
- Units: 4
- Faults (ground truth / user-known): 2 / 1
- Boreholes: 8
- Surface relief: 426 m

## Provenance

- Source: microsoft_planetary_computer
- Region: otago_schist
- Center (lon, lat): [170.52056785188222, -45.32187292750043]
- DEM: cop-dem-glo-30
...
|------|------|-----------|------------------|---------------------|
| 1 | lower_sediments | shale | -213 | 2.0e-05 |
| 2 | middle_sediments | sandstone | -169 | 3.0e-05 |
| 3 | upper_sediments | siltstone | -155 | 2.0e-05 |
| 4 | conglomerate | conglomerate | -225 | 4.0e-05 |

## Regenerate

```python
from geogen.stratiflow import GenerationConfig, generate_sample
cfg = GenerationConfig(seed=20260511)
